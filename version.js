if (!process.argv[2] || process.argv[2] == 'help') {
    console.log('Usage: node version.js <repository> [major|minor|hotfix]');
    ...
    console.log('\n');
    console.log('Example:');
    console.log('node version.js C:\\Sites\\calculator ');
    console.log('node version.js git@github.com:user/calculator  hotfix');
    console.log('node version.js https://github.com/calculator.git  major');
    return;
}
