var flow = function (dir, version, bracnh) {
    if (!dir || dir == 'help') {
        console.log('Usage: qflow <repository> [major|minor|hotfix|release] <branch>');
        console.log('Script for release new version\n');
        console.log('  major|minor|hotfix|release                Which number of version will be incremented. Default value is minor.');
        console.log('\n');
        console.log('Note:');
